...
public class CaffeineListActivity extends AppCompatActivity
    ...
    // Last location is the last lat/lng reported
    private Location mLastLocation;
    // Location requests are meade every x seconds (we configure this)
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.e("Caffeine Finder", "Connection to Location Services failed: "
    ...
    public void findClosestCaffeine(View view) {
        ...
        for (CaffeineLocation caffeineLocation : mAllCaffeineLocationsList) {
            // convert Caffeine Location into a Google Location
            tempLocation.setLatitude(caffeineLocation.getLatitude());
            tempLocation.setLongitude(caffeineLocation.getLongitude());
        ...
        // Make new Intent to details activiy
        Intent detailsIntent = new Intent(this, CaffeineDetailsActivity.class);
